...
public class JPetStoreStepDefinitions {
	...
	public void user_navigates_to_sign_up_page() throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\IYAZMO\\OneDrive - Capgemini\\Desktop\\JPetStore-GUI2\\src\\test\\resources\\Drivers\\chromedriver.exe");
	...
	public void user_enters_dumfries_and_as_df(String username,String password) throws InterruptedException {
	...
	public void user_selects_a_particular_order_id() throws InterruptedException {
		driver.findElement(By.xpath("//a[contains(text(),'1005')]")).click();
		Thread.sleep(2000);
	}
