...
public class JpetStoreBusinessFlowTest {
	...
	public void testAccountCreatedSuccessfully() throws IOException {
		...
		FileInputStream fis1=new FileInputStream("C:\Users\IYAZMO\OneDrive - Capgemini\Desktop\New folder (2)\JpetStore-POM\CreateAccount.xlsx");
	...
	public void testHomePageAppearCorrect() throws IOException {
		...
		FileInputStream fis1=new FileInputStream("C:\Users\IYAZMO\OneDrive - Capgemini\Desktop\New folder (2)\JpetStore-POM\LoginCredentials.xlsx");
		XSSFWorkbook workbook=new XSSFWorkbook(fis1);
		XSSFSheet sheet=workbook.getSheetAt(0);
		int rowNum=sheet.getLastRowNum();
		int columnNum=sheet.getRow(0).getPhysicalNumberOfCells();
